...
Cinematic personal portfolio for **Shubham Deshmukh** built with **Next.js + React + TypeScript + Tailwind CSS + Framer Motion**.
...
- Product-style project showcases: **VULISCAN**, **INTELLI**, **Blockchain Chat**
